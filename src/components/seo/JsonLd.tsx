...
const softwareSchema = {
    ...
    featureList: [
        ...
        'Computed Deadlines with Per-Date Derivation Traces (supported PCT and U.S. office-action rules)',
        ...
        'CSV Export',
        'Deadline Reminders and Email Digests',
        'Private Calendar Deadline Feeds (Outlook, Google, Apple Calendar)',
        'Branded PDF Reports with Verifiable SHA-256 Integrity',
        'Loss of Exclusivity Timeline with Protection-Horizon What-If',
